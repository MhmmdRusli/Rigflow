...
export default function Create({ projects }) {
    ...
    return (
        <AuthenticatedLayout>
            ...
            <h1 className="font-display mb-6 text-2xl font-semibold text-slate-900">Tambah Kru</h1>
            ...
            <form onSubmit={submit} className="max-w-lg space-y-5 rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
                ...
                <div>
                    ...
                    <input type="text" value={data.position} onChange={(e) => setData('position', e.target.value)} placeholder="Driller, Helper, dll" className={inputClass} />
                </div>
